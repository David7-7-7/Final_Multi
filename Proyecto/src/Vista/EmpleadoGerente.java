 ...
 * @author jefer
 */
public class EmpleadoGerente extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpleadoGerente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
